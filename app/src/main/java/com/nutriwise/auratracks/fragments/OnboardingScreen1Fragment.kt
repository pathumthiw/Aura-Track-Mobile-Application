...
import com.nutriwise.auratracks.databinding.FragmentOnboardingScreen1Binding

/**
 * First onboarding screen - Welcome to AuraTrack
 * Shows meditation illustration with welcome message
 */
    ...
    private fun setupClickListeners() {
        try {
            ...
            binding.skipButton.setOnClickListener {
                findNavController().navigate(R.id.action_onboardingScreen1Fragment_to_onboardingScreen3Fragment)
            }
        } catch (e: Exception) {
            e.printStackTrace()
        }
